...
export default function AboutPreview() {
  return (
    <section id="about" className="bg-wheat/30 py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <div className="rounded-2xl bg-espresso/10 aspect-square flex items-center justify-center">
              <svg
                viewBox="0 0 120 120"
                className="w-24 h-24 text-espresso/20"
                fill="currentColor"
                aria-hidden="true"
              >
          ...
          >
            ...
            <h2 className="mt-3 font-serif text-3xl md:text-4xl text-espresso leading-tight">
              Rooted in Craft,
              <br />
              Driven by Community
            </h2>
